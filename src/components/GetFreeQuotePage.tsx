    ...
    } */}
{
    ...
    <div>
      ...
      <div className="w-full bg-no-repeat bg-[url('/images/contactbanner.png')] ">
        ...
        <div className=" mx-auto xl:w-[95%]  2xl:w-[75%]  px-4  py-24 flex flex-wrap md:flex-nowrap justify-center gap-8 items-start">

          <div className="w-full xl:w-[95%]  2xl:w-[75%] p-8  shadow-xl rounded-2xl bg-white">
            ...
            <HubspotForm  portalId="20095080" formId={"fa975034-9559-4ada-bdfe-bb84df26e68d"} region={'na1'}/>
          </div>
        </div>
      </div>
