        ...
        <div className=' w-full border-t border-[2px] border-lightblue'>
            <div className='xl:w-[95%]  2xl:w-[75%] mx-auto px-6 my-12'>
                ...
                <div className='mt-10 flex justify-center gap-6 flex-wrap'>
                    {
                        [1, 2, 3, 4, 5, 6, 7, 8].map((elem: any, i:number) => (
                            <div key={i} className='rounded-xl p-8 sm:w-[43%] md:w-[31%] lg:w-[23%] min-h-[357px] flex flex-col gap-2 justify-between border-[2px] border-lightblue bg-white hover:shadow-xl'>
