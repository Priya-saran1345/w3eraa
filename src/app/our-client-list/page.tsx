                    ...
                    <div className='flex justify-center flex-wrap mt-10 items-center gap-2'>
                        {
                            apidata?.brand.map((elem:any, index:number) => {
                                return (
                                    <div key={index} className='bg-white rounded-sm flex justify-center items-center size-[160px] md:size-[217px]'>
                                        <Image
                                            src={elem?.image} // Ensure this path is correct
                                            alt=''
                                            height={75}
                                            width={120}
                                        />
                ...
                <div className='w-full pt-20 bg-[url("/images/footer-bg.png")] bg-cover bg-center '>
                    <div className='w-full relative  xl:w-[75%] mx-auto py-8  bg-white flex justify-between items-center '>
                        <div className=' bg-white md:w-[55%] flex-col flex text-center md:text-left px-12 py-10 md:py-0 '>
                           ...
                           {client?.reput_ation[0].description}
                            </p>
                        ...
                        <div>
                            <Image src={'/images/pana.png'} height={512} width={588} alt='' className='hidden md:block'/>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='flex flex-wrap mt-10 gap-5 justify-center'>
                        {
                            client?.whychoose_w3era.map((elem: any, index: number) => {
                                return ( // Add return statement here
                                    <div key={index} className='hover:shadow-lg flex flex-col gap-4 min-w-[358px] w-[378px] h-[261px] px-5 justify-center rounded-lg group transition-shadow duration-300'>
