            ...
            <div className='bg-white mt-12 xl:w-[75%] px-4 xl:px-0 mx-auto'>
                ...
                <div className='flex justify-between lg:gap-16'>
                    ...
                    <div className='w-full min-h-[377px]'>
                        ...
                        >
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam eos nesciunt accusantium quas culpa. Magnam natus veniam temporibus incidunt culpa harum ea cumque beatae, voluptate aut accusantium id alias sint?
                        </p>
